...
function addSeconds(time, seconds) {
  ...
  var newSeconds = time.seconds + seconds;
...
var seconds = +prompt('на сколько увеличить время в секундах');
console.log(currTime(addSeconds(currentTime, seconds))); // function currTimeAndSeconds(hours, minutes, seconds) {
